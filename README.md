...
6.4. Define your PDC storage project directory (change **\<PATH TO PDC PROJECT DIRECTORY\>** for the full path to your PDC storage project directory, which can be found on https://supr.naiss.se/).
